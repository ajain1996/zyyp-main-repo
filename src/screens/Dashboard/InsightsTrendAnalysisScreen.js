...
export default function InsightsTrendAnalysisScreen({ navigation }) {
    ...
    return (
        <View style={styles.headerContainer}>
            ...
            >
                <TouchableOpacity
                    onPress={() => {
                        navigation.navigate("InsightsForASpecificPeriod");
                    }}
                >
                ...
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                    ...
                    >
                        ...
                        <CustomTextComponent text="Trend Analysis" fs={14} color={"#000"} />
                        {isEnabled
                            ? <>
                                <View style={{ width: 14 }} />
                                <View
